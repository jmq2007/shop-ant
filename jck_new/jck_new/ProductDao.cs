...
namespace Common
{
	...
	public class ProductDao
	{
		...
		public static int insert(Product_buy p)
		{
			...
			parameters[5]=new OleDbParameter("@buy_date",OleDbType.Date);
        ...
        {
            string sql = "select id,code,class,p_name,amount,sale_price,price,buy_date,other from tbl_buy where code=?";
            OleDbParameter[] parameters = new OleDbParameter[1];
            parameters[0] = new OleDbParameter("@code" ,OleDbType.VarChar, 50);
        ...
        {
            string sql = "insert into tbl_sale(code,p_name,class,sale_price,amount,price,sale_date,other)values(?,?,?,?,?,?,?,?);";
            OleDbParameter[] parameters = new OleDbParameter[8];
            parameters[0] = new OleDbParameter("@code", OleDbType.VarChar, 50);
            parameters[0].Value = p.Code;
            parameters[1] = new OleDbParameter("@p_name", OleDbType.VarChar, 50);
            ...
            parameters[3] = new OleDbParameter("@sale_price", OleDbType.Double);
            parameters[3].Value = p.Price_sale;
            parameters[4] = new OleDbParameter("@amount", OleDbType.Integer);
        ...
        {
            string sql = "update tbl_buy set code=?,p_name=?,class=?,sale_price=?,amount=?,price=?,sale_date=?,other=? where id=?";
        ...
        {
            string sql = "select id,code,class,p_name,amount,sale_price,price,sale_date,other from tbl_sale where id=?";
            OleDbParameter[] parameters = new OleDbParameter[1];
            parameters[0] = new OleDbParameter("@id", OleDbType.Integer);
            parameters[0].Value = id;
            DataSet ds = AccessDBUtil.ExecuteQuery(sql, parameters);
        ...
        {
            string sql = "select id,code,p_name,amount,sale_price,price,buy_date,other from tbl_sale where code=?";
            OleDbParameter[] parameters = new OleDbParameter[1];
            parameters[0] = new OleDbParameter("@code", OleDbType.VarChar, 50);
            parameters[0].Value = code;
            DataSet ds = AccessDBUtil.ExecuteQuery(sql, parameters);
